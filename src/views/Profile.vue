    ...
    <div class="col-md-9">
      ...
      <div class="row" v-if="isActivated">
        ...
        <div class="col-md-6 mb-3">
          <div class="container text-center">
            <h3>Balance</h3>
            <p class="text-break">{{ formatter.format(getPaymentTokenBalance) }} {{this.getPaymentTokenName}}</p>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("user", ["getUserAddress", "getPaymentTokenName", "getUserSelectedNameData", "getUserAllDomainNames", "getPaymentTokenAddress", "getPaymentTokenAllowance", "getPaymentTokenBalance", "getUserBalance", "getPaymentTokenContract"]),
